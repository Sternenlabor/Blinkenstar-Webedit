...
if (legacyAnimations) {
    try {
        Map<string, Animation>(JSON.parse(legacyAnimations)).map((animation) => {
...
const initialAnimations = Object.keys(localStorage).reduce<Map<string, Animation>>((animations, key) => {
