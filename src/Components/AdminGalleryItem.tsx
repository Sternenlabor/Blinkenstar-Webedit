...
type Props = {
    ...
    handlePrimary: ((animation: Animation) => unknown),
    handleSecondary?: ((animation: Animation) => unknown),
...
function getActionLabel(t: ((arg0: string, arg1: string) => string), action: ActionName): string {
    if (action === 'add') {
